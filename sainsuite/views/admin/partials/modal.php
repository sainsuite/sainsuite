...
<!--begin::Compose-->
<div class="modal modal-sticky modal-sticky-lg modal-sticky-bottom-right" id="sit_compose" role="dialog" data-backdrop="false">
...
<script type="text/javascript">
    ...
    function composeModal(url, header)
    {
        ...
        $('#sit_compose .modal-title').html(header);
        $('#sit_compose .form').attr('action', url);
        // LOADING THE AJAX MODAL
        $('#sit_compose').modal('show', {backdrop: 'true'});
    }
