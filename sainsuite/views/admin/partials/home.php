<div class="d-flex flex-column-fluid flex-center" id="sit_home">
    <div class="d-flex flex-column justify-content-center align-items-center px-5 text-center">
        ...
        <?php _e('See What We Doing When You Are Enjoying Our Product');?> <br>
        <?php _e('Get started building your personal projects, testing out ideas, and more in your spontaner workspace.');?>
        </p>
    </div>
</div>