<div class="login-form">   
    ...
    <form method="post" id="sit_login_forgot_form" autocomplete="off" class="form required-form">
        <!--begin::Title-->
        ...
        <div class="row form-group d-flex flex-wrap">
            <div class="btn-group col">
                <a href="<?php echo site_url(array( 'login' ));?>" id="sit_login_forgot_cancel" class="btn btn-light-primary font-weight-bolder font-size-h6 px-8 py-4 my-3">Cancel</a>
                <button type="submit" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3">
                    <span class="position-relative" id="sit_login_forgot_form_submit_button"><?php _e('Submit' ) ?></span>
                </button>
            </div>
        </div>
        <!--end::Form group-->
